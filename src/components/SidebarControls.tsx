...
export const SidebarControls = ({ draft, onUpdate }: ControlsProps) => {
  ...
  return (
    <aside className="lg:col-span-4 space-y-6 p-4">
      <section className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 space-y-6">
        ...
        <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
          <button
            ...
            className="w-full flex items-center justify-between text-sm font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wider"
          >
